...
## slurm
export JOB_NAME=rankmind_llama3_70b_plan_gpt_o4_sft
export output_dir=/checkpoints/your_username/rankmind/llama3_70b_plan_gpt_o4_sft
export train_dataset=plan_gpt_o4_mini_rollout_train
export eval_dataset=plan_gpt_o4_mini_rollout_test
