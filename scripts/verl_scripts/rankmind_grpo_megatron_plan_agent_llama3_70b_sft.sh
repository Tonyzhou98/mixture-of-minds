...
#SBATCH --mem 500G
#SBATCH --job-name=rankmind_llama3_70b_sft_rl_grpo_megatron_plan_agent
#SBATCH --output=/your/path/to/your_fs/verl/slurm/rankmind_llama3_70b_sft_rl_grpo_megatron_plan_agent.stdout
#SBATCH --error=/your/path/to/your_fs/verl/slurm/rankmind_llama3_70b_sft_rl_grpo_megatron_plan_agent.stderr
...
experiment_name="rankmind_llama3_70b_sft_grpo_megatron_plan_agent"
ROOT_DIR=/your/path/to/your_fs/verl
CHECKPOINT_PATH=/checkpoints/your_username
HF_MODEL_PATH=/checkpoints/your_username/rankmind/llama3_70b_plan_gpt_o4_sft/checkpoint-80
...
PYTHONUNBUFFERED=1 srun --overlap --nodes=1 --ntasks=1 -w "$head_node" \
  bash -c "
    ...
    data.train_files=$DATA_PATH/llama3_70b_sft_gpt_plan_grpo_data_train.parquet \
    data.val_files=$DATA_PATH/llama3_70b_sft_gpt_plan_grpo_data_test.parquet \
    ...
    custom_reward_function.name=compute_score_batch_nonreasoning_bleu \
