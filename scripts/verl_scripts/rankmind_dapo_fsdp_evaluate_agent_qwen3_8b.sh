...
#SBATCH --mem 128G
#SBATCH -c 64
#SBATCH --job-name=rankmind_qwen3_8b_rl_dapo_evaluate_agent
#SBATCH --output=/your/path/to/your_fs/verl/slurm/rankmind_qwen3_8b_rl_dapo_evaluate_agent.stdout
#SBATCH --error=/your/path/to/your_fs/verl/slurm/rankmind_qwen3_8b_rl_dapo_evaluate_agent.stderr
...
experiment_name="rankmind_qwen3_8b_dapo_evaluate_agent"
...
PYTHONUNBUFFERED=1 python3 -m recipe.dapo.main_dapo \
    ...
    custom_reward_function.name=compute_score_evaluate \
