...
#SBATCH --mem 128G
#SBATCH -c 64
#SBATCH --job-name=rankmind_qwen3_8b_rl_grpo
#SBATCH --output=/your/path/to/your_fs/verl/slurm/rankmind_qwen3_8b_rl_grpo.stdout
#SBATCH --error=/your/path/to/your_fs/verl/slurm/rankmind_qwen3_8b_rl_grpo.stderr
...
experiment_name="rankmind_qwen3_8b_grpo"
