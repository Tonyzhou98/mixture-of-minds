...
#SBATCH --mem 500G
#SBATCH --job-name=rankmind_qwen3_32b_grpo_megatron_evaluate_agent_best_answer
#SBATCH --output=/your/path/to/your_fs/verl/slurm/rankmind_qwen3_32b_rl_grpo_megatron_evaluate_agent_best_answer.stdout
#SBATCH --error=/your/path/to/your_fs/verl/slurm/rankmind_qwen3_32b_rl_grpo_megatron_evaluate_agent_best_answer.stderr
...
experiment_name="rankmind_qwen3_32b_grpo_megatron_evaluate_agent_best_answer"
...
PYTHONUNBUFFERED=1 srun --overlap --nodes=1 --ntasks=1 -w "$head_node" \
  bash -c "
    ...
    data.train_files=$DATA_PATH/qwen3_32b_evaluate_best_answer_data_causalanal_descriptiveanal_anomalydetect_train.parquet \
    data.val_files=$DATA_PATH/qwen3_32b_evaluate_best_answer_data_causalanal_descriptiveanal_anomalydetect_test.parquet \
