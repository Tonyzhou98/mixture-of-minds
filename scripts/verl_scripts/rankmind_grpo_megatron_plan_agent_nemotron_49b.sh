...
#SBATCH --chdir=/home/your_username/verl/
#SBATCH --nodes 4 
#SBATCH --tasks-per-node 8 
#SBATCH --cpus-per-task 24 
#SBATCH --gpus-per-node 8
#SBATCH --mem 500G
#SBATCH --job-name=rankmind_nemotron_49b_rl_grpo_megatron_plan_agent
#SBATCH --output=/home/your_username/verl/slurm/rankmind_nemotron_49b_rl_grpo_megatron_plan_agent.stdout
#SBATCH --error=/home/your_username/verl/slurm/rankmind_nemotron_49b_rl_grpo_megatron_plan_agent.stderr
...
experiment_name="rankmind_nemotron_49b_grpo_megatron_plan_agent"
ROOT_DIR=/home/your_username/verl
CHECKPOINT_PATH=/your_fs/test/checkpoints
HF_MODEL_PATH=/your_fs/test/Llama/Llama-3_3-Nemotron-Super-49B-v1_5/
DATA_PATH=/home/your_username/RankMind/datasets/train_data
REWARD_PATH=/home/your_username/RankMind/reward_functions/table_reasoning_reward.py
DIST_CKPT_PATH=/your_fs/test/Llama/Llama-3_3-Nemotron-Super-49B-v1_5-mcore
...
PYTHONUNBUFFERED=1 srun --overlap --nodes=1 --ntasks=1 -w "$head_node" \
  bash -c "
    ...
    data.train_files=$DATA_PATH/qwen3_32b_plan_grpo_data_train.parquet \
    data.val_files=$DATA_PATH/qwen3_32b_plan_grpo_data_test.parquet \
    ...
    custom_reward_function.name=compute_score_batch_bleu \
