...
#SBATCH --mem 128G
#SBATCH -c 64
#SBATCH --job-name=rankmind_qwen3_8b_rl_grpo_plan_agent
#SBATCH --output=/your/path/to/your_fs/verl/slurm/rankmind_qwen3_8b_rl_grpo_plan_agent.stdout
#SBATCH --error=/your/path/to/your_fs/verl/slurm/rankmind_qwen3_8b_rl_grpo_plan_agent.stderr
...
experiment_name="rankmind_qwen3_8b_grpo_plan_agent"
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=$DATA_PATH/qwen3_8b_plan_grpo_data_train.parquet \
    data.val_files=$DATA_PATH/qwen3_8b_plan_grpo_data_test.parquet \
