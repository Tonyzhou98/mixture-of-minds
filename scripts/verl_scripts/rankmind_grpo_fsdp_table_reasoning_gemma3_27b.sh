...
#SBATCH --mem 128G
#SBATCH -c 64
#SBATCH --job-name=rankmind_gemma3_27b_rl_grpo_table_reasoning
#SBATCH --output=/your/path/to/your_fs/verl/slurm/rankmind_gemma3_27b_rl_grpo_table_reasoning.stdout
#SBATCH --error=/your/path/to/your_fs/verl/slurm/rankmind_gemma3_27b_rl_grpo_table_reasoning.stderr
...
experiment_name="rankmind_gemma3_27b_grpo_table_reasoning"
