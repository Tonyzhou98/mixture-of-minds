...
#SBATCH --mem 128G
#SBATCH -c 64
#SBATCH --job-name=rankmind_gemma3_27b_rl_grpo_code_agent
#SBATCH --output=/your/path/to/your_fs/code/verl/slurm/rankmind_gemma3_27b_rl_grpo_code_agent.stdout
#SBATCH --error=/your/path/to/your_fs/code/verl/slurm/rankmind_gemma3_27b_rl_grpo_code_agent.stderr
...
experiment_name="rankmind_gemma3_27b_grpo_code_agent"
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=$DATA_PATH/gemma3_27b_textonly_code_grpo_data_train.parquet \
    data.val_files=$DATA_PATH/gemma3_27b_textonly_code_grpo_data_test.parquet \
