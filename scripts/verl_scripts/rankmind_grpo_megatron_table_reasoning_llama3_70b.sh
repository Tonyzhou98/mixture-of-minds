...
#SBATCH --mem 500G
#SBATCH --job-name=rankmind_llama3_70b_table_reasoning_rl_grpo_megatron
#SBATCH --output=/your/path/to/your_fs/verl/slurm/rankmind_llama3_70b_table_reasoning_rl_grpo_megatron.stdout
#SBATCH --error=/your/path/to/your_fs/verl/slurm/rankmind_llama3_70b_table_reasoning_rl_grpo_megatron.stderr
...
experiment_name="rankmind_llama3_70b_table_reasoning_grpo_megatron"
