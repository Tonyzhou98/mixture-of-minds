...
#SBATCH --mem 500G
#SBATCH --job-name=rankmind_llama3_70b_r1_rl_grpo_megatron_plan_agent
#SBATCH --output=/your/path/to/your_fs/verl/slurm/rankmind_llama3_70b_r1_rl_grpo_megatron_plan_agent.stdout
#SBATCH --error=/your/path/to/your_fs/verl/slurm/rankmind_llama3_70b_r1_rl_grpo_megatron_plan_agent.stderr
...
experiment_name="rankmind_llama3_70b_r1_grpo_megatron_plan_agent"
...
PYTHONUNBUFFERED=1 srun --overlap --nodes=1 --ntasks=1 -w "$head_node" \
  bash -c "
    ...
    data.train_files=$DATA_PATH/llama3_70b_r1_plan_grpo_data_train.parquet \
    data.val_files=$DATA_PATH/llama3_70b_r1_plan_grpo_data_test.parquet \
