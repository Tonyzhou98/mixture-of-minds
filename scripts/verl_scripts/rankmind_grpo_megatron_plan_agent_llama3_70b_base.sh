...
#SBATCH --mem 500G
#SBATCH --job-name=rankmind_llama3_70b_rl_grpo_megatron_plan_agent
#SBATCH --output=/your/path/to/your_fs/verl/slurm/rankmind_llama3_70b_rl_grpo_megatron_plan_agent.stdout
#SBATCH --error=/your/path/to/your_fs/verl/slurm/rankmind_llama3_70b_rl_grpo_megatron_plan_agent.stderr
...
experiment_name="rankmind_llama3_70b_grpo_megatron_plan_agent"
ROOT_DIR=/your/path/to/your_fs/verl
CHECKPOINT_PATH=/checkpoints/your_username
HF_MODEL_PATH=/your/path/to/your_fs/Llama/Llama-3.3-70B-Instruct
...
PYTHONUNBUFFERED=1 srun --overlap --nodes=1 --ntasks=1 -w "$head_node" \
  bash -c "
    ...
    data.train_files=$DATA_PATH/llama3_70b_plan_grpo_data_train.parquet \
    data.val_files=$DATA_PATH/llama3_70b_plan_grpo_data_test.parquet \
