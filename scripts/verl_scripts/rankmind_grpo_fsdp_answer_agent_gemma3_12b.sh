...
#SBATCH --mem 128G
#SBATCH -c 64
#SBATCH --job-name=rankmind_gemma3_12b_rl_grpo_answer_agent
#SBATCH --output=/your/path/to/your_fs/code/verl/slurm/rankmind_gemma3_12b_rl_grpo_answer_agent.stdout
#SBATCH --error=/your/path/to/your_fs/code/verl/slurm/rankmind_gemma3_12b_rl_grpo_answer_agent.stderr
...
experiment_name="rankmind_gemma3_12b_grpo_answer_agent"
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=$DATA_PATH/gemma3_12b_textonly_answer_grpo_data_train.parquet \
    data.val_files=$DATA_PATH/gemma3_12b_textonly_answer_grpo_data_test.parquet \
