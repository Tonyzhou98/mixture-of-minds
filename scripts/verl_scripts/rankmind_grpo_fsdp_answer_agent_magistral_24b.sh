...
#SBATCH --mem 128G
#SBATCH -c 64
#SBATCH --job-name=rankmind_magistral_24b_rl_grpo_answer_agent
#SBATCH --output=/your/path/to/your_fs/verl/slurm/rankmind_magistral_24b_rl_grpo_answer_agent.stdout
#SBATCH --error=/your/path/to/your_fs/verl/slurm/rankmind_magistral_24b_rl_grpo_answer_agent.stderr
...
experiment_name="rankmind_magistral_24b_grpo_answer_agent"
ROOT_DIR=/your/path/to/your_fs/verl
CHECKPOINT_PATH=/checkpoints/your_username
MODEL_PATH=/your/path/to/your_fs/mistral/Magistral-Small-2506
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=$DATA_PATH/magistral_24b_answer_grpo_data_train.parquet \
    data.val_files=$DATA_PATH/magistral_24b_answer_grpo_data_test.parquet \
