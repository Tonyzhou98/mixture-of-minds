...
#SBATCH --mem 500G
#SBATCH --job-name=rankmind_qwen3_32b_rl_grpo_megatron_answer_agent
#SBATCH --output=/your/path/to/your_fs/code/verl/slurm/rankmind_qwen3_32b_rl_grpo_megatron_answer_agent.stdout
#SBATCH --error=/your/path/to/your_fs/code/verl/slurm/rankmind_qwen3_32b_rl_grpo_megatron_answer_agent.stderr
...
experiment_name="rankmind_qwen3_32b_grpo_megatron_answer_agent"
ROOT_DIR=/your/path/to/your_fs/code/verl
CHECKPOINT_PATH=/checkpoints/your_username/Qwen3-32B
...
# Fix for cuDNN 9.10.2 sublibrary loading issue
export CUDNN_LOGERR_DBG=1
export CUDNN_LOGDEST_DBG=stderr

# Point to the correct cuDNN 9.10.2 libraries
export LD_LIBRARY_PATH=/usr/local/cuda-12.8/lib:$LD_LIBRARY_PATH
export LD_LIBRARY_PATH=/usr/local/cuda-12.8/lib64:$LD_LIBRARY_PATH

# Ensure all cuDNN 9.x sublibraries are found
export CUDNN_PATH=/usr/local/cuda-12.8
export LD_PRELOAD=/usr/local/cuda-12.8/lib/libcudnn.so.9
export NVTE_FUSED_ATTN=0
export NVTE_FLASH_ATTN=1
export export NVTE_FUSED_BIAS=0
...
PYTHONUNBUFFERED=1 srun --overlap --nodes=1 --ntasks=1 -w "$head_node" \
  bash -c "
    ...
    data.train_files=$DATA_PATH/qwen3_32b_answer_grpo_data_train.parquet \
    data.val_files=$DATA_PATH/qwen3_32b_answer_grpo_data_test.parquet \
    ...
    custom_reward_function.name=compute_score_batch_multiturn \
