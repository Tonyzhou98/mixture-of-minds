...
#SBATCH --mem 128G
#SBATCH -c 64
#SBATCH --job-name=rankmind_llama3_8b_rl_grpo
#SBATCH --output=/your/path/to/your_fs/verl/slurm/rankmind_llama3_8b_rl_grpo.stdout
#SBATCH --error=/your/path/to/your_fs/verl/slurm/rankmind_llama3_8b_rl_grpo.stderr
...
experiment_name="rankmind_llama3_8b_grpo"
