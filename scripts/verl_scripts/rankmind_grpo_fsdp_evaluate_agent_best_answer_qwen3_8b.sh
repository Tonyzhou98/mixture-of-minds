...
#SBATCH --mem 128G
#SBATCH -c 64
#SBATCH --job-name=rankmind_qwen3_8b_rl_grpo_evaluate_agent_best_answer
#SBATCH --output=/your/path/to/your_fs/verl/slurm/rankmind_qwen3_8b_rl_grpo_evaluate_agent_best_answer.stdout
#SBATCH --error=/your/path/to/your_fs/verl/slurm/rankmind_qwen3_8b_rl_grpo_evaluate_agent_best_answer.stderr
...
experiment_name="rankmind_qwen3_8b_grpo_evaluate_agent_best_answer"
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=$DATA_PATH/qwen3_8b_evaluate_best_answer_data_causalanal_descriptiveanal_anomalydetect_train.parquet \
    data.val_files=$DATA_PATH/qwen3_8b_evaluate_best_answer_data_causalanal_descriptiveanal_anomalydetect_test.parquet \
    ...
    custom_reward_function.name=compute_score_batch_best_answer \
    ...
    trainer.test_freq=5 \
    trainer.total_epochs=30 2>&1 | tee logs/${project_name}/${experiment_name}.log
