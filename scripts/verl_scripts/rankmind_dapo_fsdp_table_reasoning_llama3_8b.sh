...
#SBATCH --mem 128G
#SBATCH -c 64
#SBATCH --job-name=rankmind_llama3_8b_rl_dapo
#SBATCH --output=/your/path/to/your_fs/verl/slurm/rankmind_llama3_8b_rl_dapo.stdout
#SBATCH --error=/your/path/to/your_fs/verl/slurm/rankmind_llama3_8b_rl_dapo.stderr
...
experiment_name="rankmind_llama3_8b_dapo"
ROOT_DIR=/your/path/to/your_fs/verl
CHECKPOINT_PATH=/your/path/to/your_fs/checkpoints
MODEL_PATH=/your/path/to/your_fs/Llama/Llama-3.1-8B-Instruct
