...
#SBATCH --mem 128G
#SBATCH -c 64
#SBATCH --job-name=rankmind_llama3_8b_sft_grpo_plan_agent
#SBATCH --output=/your/path/to/your_fs/verl/slurm/rankmind_llama3_8b_sft_grpo_plan_agent.stdout
#SBATCH --error=/your/path/to/your_fs/verl/slurm/rankmind_llama3_8b_sft_grpo_plan_agent.stderr
...
experiment_name="rankmind_llama3_8b_sft_grpo_plan_agent"
ROOT_DIR=/your/path/to/your_fs/verl
CHECKPOINT_PATH=/your/path/to/your_fs/checkpoints
MODEL_PATH=/your/path/to/your_fs/checkpoints/rankmind/llama3_8b_plan_gpt_o4_sft
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=$DATA_PATH/llama3_8b_sft_plan_grpo_data_train.parquet \
    data.val_files=$DATA_PATH/llama3_8b_sft_plan_grpo_data_test.parquet \
