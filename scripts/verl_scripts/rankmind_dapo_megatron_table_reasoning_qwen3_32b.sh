...
#SBATCH --mem 500G
#SBATCH --job-name=rankmind_qwen3_32b_rl_dapo_megatron_table_reasoning
#SBATCH --output=/your/path/to/your_fs/verl/slurm/rankmind_qwen3_32b_rl_dapo_megatron_table_reasoning.stdout
#SBATCH --error=/your/path/to/your_fs/verl/slurm/rankmind_qwen3_32b_rl_dapo_megatron_table_reasoning.stderr
...
experiment_name="rankmind_qwen3_32b_dapo_megatron_agent"
