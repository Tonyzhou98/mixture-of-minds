...
#SBATCH --mem 500G
#SBATCH --job-name=rankmind_qwen3_32b_rl_grpo_megatron
#SBATCH --output=/your/path/to/your_fs/verl/slurm/rankmind_qwen3_32b_rl_grpo.stdout
#SBATCH --error=/your/path/to/your_fs/verl/slurm/rankmind_qwen3_32b_rl_grpo.stderr
...
experiment_name="rankmind_qwen3_32b_grpo_megatron"
