...
#SBATCH --mem 128G
#SBATCH -c 64
#SBATCH --job-name=rankmind_gemma3_27b_rl_dapo_table_reasoning
#SBATCH --output=/your/path/to/your_fs/verl/slurm/rankmind_gemma3_27b_rl_dapo_table_reasoning.stdout
#SBATCH --error=/your/path/to/your_fs/verl/slurm/rankmind_gemma3_27b_rl_dapo_table_reasoning.stderr

set -x

export HF_HOME="/your/path/to/your_fs/hf"
export HF_DATASETS_CACHE="/your/path/to/your_fs/hf"
export HF_HUB_CACHE="/your/path/to/your_fs/hf"
...
experiment_name="rankmind_gemma3_27b_dapo"
ROOT_DIR=/your/path/to/your_fs/verl
CHECKPOINT_PATH=/your/path/to/your_fs/checkpoints
MODEL_PATH=/your/path/to/your_fs/gemma/gemma3_27b_textonly
