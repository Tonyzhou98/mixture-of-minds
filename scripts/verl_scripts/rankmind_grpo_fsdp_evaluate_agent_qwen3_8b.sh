...
#SBATCH --mem 128G
#SBATCH -c 64
#SBATCH --job-name=rankmind_qwen3_8b_rl_grpo_evaluate_agent
#SBATCH --output=/your/path/to/your_fs/verl/slurm/rankmind_qwen3_8b_rl_grpo_evaluate_agent.stdout
#SBATCH --error=/your/path/to/your_fs/verl/slurm/rankmind_qwen3_8b_rl_grpo_evaluate_agent.stderr
...
experiment_name="rankmind_qwen3_8b_grpo_evaluate_agent"
...
# MODEL_PATH=/your/path/to/your_fs/checkpoints/rankmind/rankmind_qwen3_8b_grpo_answer_agent/global_step_125/actor/huggingface
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=$DATA_PATH/qwen3_8b_evaluate_grpo_data_train.parquet \
    data.val_files=$DATA_PATH/qwen3_8b_evaluate_grpo_data_test.parquet \
    ...
    custom_reward_function.name=compute_score_batch_evaluate \
