...
#SBATCH --mem 128G
#SBATCH -c 64
#SBATCH --job-name=rankmind_gemma3_12b_rl_grpo_plan_agent
#SBATCH --output=/your/path/to/your_fs/code/verl/slurm/rankmind_gemma3_12b_rl_grpo_plan_agent.stdout
#SBATCH --error=/your/path/to/your_fs/code/verl/slurm/rankmind_gemma3_12b_rl_grpo_plan_agent.stderr
...
experiment_name="rankmind_gemma3_12b_grpo_plan_agent"
ROOT_DIR=/your/path/to/your_fs/code/verl
CHECKPOINT_PATH=/your/path/to/your_fs/checkpoints
MODEL_PATH=/your/path/to/your_fs/models/gemma3_12b_textonly
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=$DATA_PATH/gemma3_12b_plan_grpo_data_train.parquet \
    data.val_files=$DATA_PATH/gemma3_12b_plan_grpo_data_test.parquet \
