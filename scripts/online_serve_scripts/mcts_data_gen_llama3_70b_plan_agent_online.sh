...
srun --nodes=1 --ntasks=1 --overlap -w "$head_node" vllm serve /checkpoints/your_username/rankmind/rankmind_llama3_70b_r1_grpo_megatron_plan_agent/global_step_120/actor/huggingface \
  --trust-remote-code \
  --seed=1 \
  --port 8001 \
  --served-model-name "llama3_70b_r1_grpo_megatron_plan_agent" \
